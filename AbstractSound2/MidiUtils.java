...
/**
 * MidiUtils - a wrapper for Java's MIDI libraries
 * 
...
public final class MidiUtils {
    ...
    */
    ...
    static public void programChange(MidiDevice outDev, int channel, int patchNum) {
      try {
        ShortMessage shortMessage = new ShortMessage();
        shortMessage.setMessage(ShortMessage.PROGRAM_CHANGE, channel, patchNum, 0);
        sendMessage(outDev, shortMessage); 
      } catch (Exception e) {
        System.err.println(e.getMessage()); 
      }
    }
