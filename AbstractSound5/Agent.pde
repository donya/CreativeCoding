/*
Agent class for Abstract Sound 5
Donya Quick
*/
...
class Agent {
  ...
  void update() {
    ...
    xSpeed = bounce(xSpeed + xAccel, x, aSize,width-aSize);
    ySpeed = bounce(ySpeed + yAccel, y, aSize, height-aSize);
